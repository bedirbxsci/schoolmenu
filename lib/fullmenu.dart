...
class _FullMenuState extends State<FullMenu> {
  ...
  Widget build(BuildContext context) {
    // 1
    return Scaffold(
      backgroundColor: Color.fromARGB(245, 139, 148, 163),
      appBar: AppBar(
      ...
      body: SafeArea(
        ...
        child: Column(
          children: <Widget>[
            // 4
            Container(
              decoration: BoxDecoration(border: Border.all(), color:  Color.fromRGBO(64,68,114,1.0), borderRadius: BorderRadius.all(Radius.circular(20))),
              height: 300,
            ...
            child: Text(
              widget.eat.label,
              style: const TextStyle(fontSize: 25, color: Color.fromARGB(255, 194, 116, 7)),
            ),
          ),
            const Text(
